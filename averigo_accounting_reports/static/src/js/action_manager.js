//odoo.define('averigo_accounting_reports.action_manager', function (require) {
//"use strict";
//
///**
...
//        return def;
//    },
//    _executexlsxInvoiceReportDownloadAction: function (action) {
//        console.log("_executexlsxInvoiceReportDownloadAction");
//        framework.blockUI();
//        var def = $.Deferred();
//        session.get_file({
//            url: '/xlsx_invoice_reports',
//            data: action.data,
//            success: def.resolve.bind(def),
//            error: (error) => this.call('crash_manager', 'rpc_error', error),
//            complete: framework.unblockUI,
...
//
//
////        if (action.type === 'invoice_export_xlsx') {
////            return this._executexlsxReportDownloadAction(action, options);
////        }
//        if (action.report_type === 'xlsx_invoice_reports')
//        {
//            return this._executexlsxInvoiceReportDownloadAction(action, options);
//        }
//
//
